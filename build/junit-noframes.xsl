...
<xsl:template match="testsuites">
    <html>
        <head>
            <title>DataLoader Test Results</title>
    <style type="text/css">
      body {
...
<xsl:template match="testcase" mode="print.test">
    <tr valign="top">
        <xsl:attribute name="class">
            <xsl:choose>
                <xsl:when test="error/@type[.='common.formula.UnderConstructionException']">WIP</xsl:when>
                <xsl:otherwise>
            		<xsl:choose>
...
<xsl:template match="error">
	<xsl:choose>
		<xsl:when test="@type[.='common.formula.UnderConstructionException']">
