...
set PROCESS_PROPS=%3 %4 %5 %6 %7 %8 %9
echo Process properties:
echo     %PROCESS_PROPS%

:execute
..\..\installshield\_jvm\bin\java.exe -cp ..\..\jar\DataLoader.jar -Dsalesforce.config.dir=%1 com.salesforce.dataloader.process.ProcessRunner %PROCESS_OPTION% %PROCESS_PROPS% 
